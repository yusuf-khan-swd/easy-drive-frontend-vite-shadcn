...
const Footer = () => {
  ...
  return (
    <footer className="p-6 bg-gray-800 text-gray-100 mt-12">
      ...
      <div className="text-sm bg-gray-700 mt-6 py-6 rounded-lg">
        ...
        <div className="flex justify-center">
          <Link
            target="_blank"
            to="https://github.com/yusuf-khan-swd/study-nest-client"
            title="Click to view github code"
            className="mr-2"
          >
            <svg
